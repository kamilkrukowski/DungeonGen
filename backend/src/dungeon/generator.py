"""
Dungeon generation business logic using GROQ API.
"""
...
class DungeonGenerator:
    """Handles dungeon generation using GROQ API."""
    ...
    def generate_dungeon(self, user_message: str) -> dict[str, str]:
        """
        Generate a dungeon description based on user input.
